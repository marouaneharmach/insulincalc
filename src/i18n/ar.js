const ar = {
  ...
  versionActuelle: "الإصدار الحالي",
  versionInstallee: "الإصدار المثبّت",
  versionDisponible: "الإصدار المتاح",
  buildId: "معرّف البناء",
  buildDisponible: "البناء البعيد",
  dateBuild: "تاريخ البناء",
  serviceWorkerEtat: "حالة عامل الخدمة",
  cachesActifs: "الذاكرات النشطة",
  derniereVerification: "آخر تحقق",
  verifierMisesAJour: "تحقق من التحديثات",
  forcerMiseAJour: "فرض التحديث",
  miseAJourDisponible: "يوجد إصدار أحدث",
  miseAJourVersion: "تم اكتشاف إصدار بعيد: {version}",
  actualiserMaintenant: "حدّث الآن",
  diagnosticTitre: "التشخيص",
  diagnosticSousTitre: "الإصدار والبناء والذاكرة المؤقتة وتوفر التحديث",
  quoiDeNeuf: "ما الجديد",
  aucuneNouvelle: "لا توجد ملاحظات إصدار متاحة.",
  fermer: "إغلاق",
